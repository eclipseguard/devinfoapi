...
def extract_token_from_response(data, region):
    ...
    # Check new API format (success is True and token exists)
...
def ensure_jwt_token_sync(region):
    ...
    with jwt_lock:
        ...
        endpoints = {
            ...
            "default": "https://ff-jwt-gen-api.lovable.app/api/public/token?uid=7039178024&password=4F109A22826D4F4CD71BA73BD5E430565F403F8EEFE04A0D789B07A5B3C14914"
        }
        ...
        try:
            ...
            try:
                ...
                print(f"[JWT] Invalid JSON response for {region}: {json_err}")
                return None
